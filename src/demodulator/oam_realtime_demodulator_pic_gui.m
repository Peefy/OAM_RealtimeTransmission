...
if datanum ~= 0
    ...
    if channel1_en == 1
        if ispic == 1
            ...
            [constellation0, ~] = PolitDemodulatorch0(channel1Data, sampleRate);
    ...
    if channel2_en == 1
        if ispic == 1
            ...
            [constellation0, ~] = PolitDemodulatorch0(channel2Data, sampleRate);
    ...
    if channel3_en == 1
        if ispic == 1
            ...
            [constellation0, ~] = PolitDemodulatorch0(channel3Data, sampleRate);
            % QPSK
